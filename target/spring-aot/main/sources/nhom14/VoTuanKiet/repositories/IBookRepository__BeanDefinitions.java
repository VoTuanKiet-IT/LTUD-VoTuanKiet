...
/**
 * Bean definitions for {@link IBookRepository}.
 */
@Generated
public class IBookRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'IBookRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getIBookRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'iBookRepository'.
   */
  public static BeanDefinition getIBookRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, IBookRepository.class, Book.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "nhom14.VoTuanKiet.repositories.IBookRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.IBookRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new nhom14.VoTuanKiet.repositories.IBookRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getIBookRepositoryInstanceSupplier();
